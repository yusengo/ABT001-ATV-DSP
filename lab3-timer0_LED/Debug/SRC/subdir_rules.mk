...
DSP2833x_ADC_cal.obj: ../SRC/DSP2833x_ADC_cal.asm $(GEN_OPTS) $(GEN_HDRS)
	...
	"D:/TICCS/ccsv6/tools/compiler/c2000_6.2.5/bin/cl2000" --silicon_version=28 -g --define="_DEBUG" --define="LARGE_MODEL" --include_path="F:/ABT/GITPRJ/DSP/ABT001/ATV/ABT001-ATV-DSP/lab3-timer0_LED/INCLUDE" --include_path="D:/TICCS/ccsv6/tools/compiler/c2000_6.2.5/include" --include_path="/packages/ti/xdais" --diag_warning=225 --large_memory_model --float_support=fpu32 --preproc_with_compile --preproc_dependency="SRC/DSP2833x_ADC_cal.pp" $(GEN_OPTS__FLAG) "$<"
